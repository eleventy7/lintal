//! Source file handling and line indexing utilities.
//!
//! This crate is derived from [ruff_source_file](https://github.com/astral-sh/ruff)
...
use jruff_text_size::{Ranged, TextRange, TextSize};
