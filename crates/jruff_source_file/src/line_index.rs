...
use jruff_text_size::{TextLen, TextRange, TextSize};
#[cfg(feature = "serde")]
...
impl LineIndex {
    ...
    /// # use jruff_source_file::{LineIndex, OneIndexed, LineColumn};
    ...
    /// ```
    /// # use jruff_text_size::TextSize;
    /// # use jruff_source_file::{LineIndex, OneIndexed, LineColumn, SourceLocation, PositionEncoding, Line};
    /// let source = format!("\u{FEFF}{}", "def a():\n    pass");
    /// let index = LineIndex::from_source_text(&source);
    ///
    ...
    ///
    /// ```
    /// # use jruff_source_file::{SourceLocation, LineIndex, OneIndexed, PositionEncoding};
    /// # use jruff_text_size::TextSize;
    /// let source = r#"a = 4
    /// c = "some string"
    /// x = b"#;
    ...
    ///
    /// ```
    /// use jruff_source_file::{LineIndex, OneIndexed, SourceLocation, PositionEncoding};
    /// use jruff_text_size::TextSize;
        ...
        let character_byte_offset = if self.is_ascii() {
            ...
            match position_encoding {
                ...
                PositionEncoding::Utf32 => line
                    ...
                    .map(jruff_text_size::TextLen::text_len)
                    .sum(),
            }
        };
...
impl OneIndexed {
    ...
    ///
    /// ```
    /// use jruff_source_file::OneIndexed;
    ///
