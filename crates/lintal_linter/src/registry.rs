...
impl RuleRegistry {
    ...
    fn register_builtins(&mut self) {
        use crate::rules::{
            EmptyForInitializerPad, MethodParamPad, NoWhitespaceAfter, NoWhitespaceBefore,
            ParenPad, SingleSpaceSeparator, TypecastParenPad, WhitespaceAfter, WhitespaceAround,
        };
