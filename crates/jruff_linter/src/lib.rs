...
use jruff_diagnostics::Diagnostic;
use jruff_java_cst::CstNode;
use jruff_source_file::{LineIndex, SourceCode};
...
impl<'a> CheckContext<'a> {
    ...
    pub fn text_before(&self, pos: jruff_text_size::TextSize) -> &'a str {
        &self.source[..usize::from(pos)]
    }

    /// Get text after a position.
    pub fn text_after(&self, pos: jruff_text_size::TextSize) -> &'a str {
        &self.source[usize::from(pos)..]
    }
}
